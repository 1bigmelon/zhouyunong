...
from app.models.StartTime import StartTime
...
#             return falseReturn({"time":StartTime.objects().first().get_base_info()},msg="拒绝访问：已经初始化过")
#         if request.get_data():
...
# @verify_params(params=['password'])
# def initialize_instance():
#     Admin.insert_admin(g.data['password'])
